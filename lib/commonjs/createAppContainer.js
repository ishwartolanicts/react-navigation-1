...
function createNavigationContainer(Component) {
  class NavigationContainer extends _react.default.Component {
    ...
    constructor(props) {
      ...
      _defineProperty(this, "_getScreenProps", () => {
        const passedProps = _lodash.default.omit(_objectSpread({}, this.props), 'scene');

        this.props = _objectSpread({}, passedProps, {}, this.props.scene);
        return this.props;
      });
    ...
    _hasSplitPaneComponent(scene) {
      return this.props.isMultiPaneEligible === true && scene.leftSplitPaneComponent != null;
    }
    ...
    render() {
      ...
      const SplitPaneComponent = this.props.scene && this.props.scene.leftSplitPaneComponent;

      const hasSplitPaneComponent = this._hasSplitPaneComponent(this.props.scene);

      const accessibilityOption = this.props.hasModal ? 'no-hide-descendants' : 'yes';
      const isAccessible = this.props.isTopScreen && (_lodash.default.size(this.props.modals) === 0 || this.props.modals === undefined);
      ...
      }, /*#__PURE__*/_react.default.createElement(_core.NavigationProvider, {
        value: navigation
      }, /*#__PURE__*/_react.default.createElement(this.props.headerComponent, _extends({}, this.props, {
      ...
      }, hasSplitPaneComponent && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
        style: {
          width: 300,
          borderRightWidth: 1,
      ...
      }, /*#__PURE__*/_react.default.createElement(SplitPaneComponent, _extends({}, this.props, {
      ...
      }, /*#__PURE__*/_react.default.createElement(Component, _extends({}, this.props, {
        navigation: navigation
      }))))));
    }
